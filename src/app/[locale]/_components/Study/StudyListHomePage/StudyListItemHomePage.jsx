...
export default function StudyListItemHomePage() {
  return (
    <li className="shadow-md bg-white dark:shadow-white duration-300 hover:shadow-sky-600 dark:hover:shadow-sky-500">
      <Link href="#">
        ...
        <div className="relative flex items-center justify-center bg-transparent w-full h-[10rem] mb-5 ">
          <Image src="/images/demo/demo-logo-2.png" alt="Example Image" layout="fill" className="object-contain p-5" />
        </div>
