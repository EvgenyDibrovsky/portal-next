        ...
        <ul className="grid grid-cols-6 gap-[1rem]">
          <li>
            <Link href="/work" className="flex justify-center items-center flex-col group ">
              <BsBox className="border border-sky-400 dark:border-sky-300 p-5 mx-auto rounded-full w-20 h-20 duration-300 group-hover:bg-sky-300 dark:group-hover:bg-sky-500 group-hover:shadow-lg mb-4" />
              Работа
            </Link>
          </li>
