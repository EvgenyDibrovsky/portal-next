...
const Footer = () => {
  return (
    <footer className="w-full border-t-2 border-sky-200 z-50">
      <div className="bg-white dark:bg-darkBgFooter py-8 flex justify-between items-center">
      ...
      <div className="bg-bgFooterMini dark:bg-darkBgFooterMini text-footerTextMini py-5 flex justify-between items-center">
